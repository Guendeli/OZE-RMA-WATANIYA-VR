...
namespace SWS
{
    ...
    public class splineMoveEditor : moveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
			...
			EditorGUILayout.PropertyField(m_Object.FindProperty("clip"));
			EditorGUILayout.PropertyField(m_Object.FindProperty("clipEndMove"));


			EditorGUILayout.PropertyField(m_Object.FindProperty("hasRigidBody"));
			...
			EditorGUILayout.PropertyField(m_Object.FindProperty("volume"));
